                        ...
                        <TabList className="md:flex md:space-x-8 grid grid-cols-2 text-center gap-4 md:justify-center mb-10">
                            ...
                            <Tab>
                                <button type="button" className="font-medium border-b-2 border-blue-500 bg-[#605d5d12] text-blue-500 hover:shadow-blue-700 rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)] px-5 py-1.5 text-center">
                                    <div className="flex gap-2 items-center">
                                        <AiFillShopping /> Wholesale Orders
                                    </div>
                                </button>
                            </Tab>
                            <Tab>
                            ...
                            <div className='px-4 md:px-0 mb-16'>
                                ...
                                <div className="flex justify-end">
                                    <div onClick={goToAdd}>
                                        <button
                                            type="button"
                                            className="focus:outline-none text-white bg-orange-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-orange-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" 
                                            style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '' }}>
                                            <div className="flex gap-2 items-center">
                                                Add Wholesale Product <FaCartPlus size={20} />
                                            </div>
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <table key={index} className="w-full text-sm text-left text-gray-500 dark:text-gray-400 mb-8">
                                            <thead className="text-xs text-black uppercase bg-gray-200" 
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col" className="px-6 py-3">Category</th>
                                                    <th scope="col" className="px-6 py-3">Retailer Name</th>
                                            ...
                                            <tbody>
                                                {allorder.cartItems.map((item, idx) => {
                                                    ...
                                                    return (
                                                        <tr key={idx} className="bg-gray-50 border-b dark:border-gray-700" 
                                                            style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '' }}>
                                                            <td className="px-6 py-4 text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                {idx + 1}.
                                                            </td>
