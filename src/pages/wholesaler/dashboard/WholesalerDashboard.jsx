...
import WholesalerTab from './WholesalerTab';
                        ...
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-blue-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] bg-gray-100 border-gray-300 px-4 py-3 rounded-xl" 
                                ...
                                <h2 className="title-font font-medium text-3xl text-black fonts1" 
                                    style={{ color: mode === 'dark' ? 'white' : '' }}>15</h2>
                                <p className="text-blue-500 font-bold" 
                                    style={{ color: mode === 'dark' ? 'white' : '' }}>Total Products</p>
                            </div>
                        </div>
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-blue-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] bg-gray-100 border-gray-300 px-4 py-3 rounded-xl" 
                                ...
                                <h2 className="title-font font-medium text-3xl text-black fonts1" 
                                    style={{ color: mode === 'dark' ? 'white' : '' }}>25</h2>
                                <p className="text-blue-500 font-bold" 
                                    style={{ color: mode === 'dark' ? 'white' : '' }}>Total Orders</p>
                            </div>
                        </div>
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-blue-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] bg-gray-100 border-gray-300 px-4 py-3 rounded-xl" 
                                ...
                                <h2 className="title-font font-medium text-3xl text-black fonts1" 
                                    style={{ color: mode === 'dark' ? 'white' : '' }}>50</h2>
                                <p className="text-blue-500 font-bold" 
                                    style={{ color: mode === 'dark' ? 'white' : '' }}>Total Retailers</p>
                            </div>
                        </div>
                    </div>
                </div>
